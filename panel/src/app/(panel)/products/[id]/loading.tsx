    ...
    <div className="p-7 space-y-5 relative">
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-2">
          <div className="h-7 bg-cream-2 rounded-md animate-pulse w-64" />
          <div className="h-3 bg-cream-2 rounded-md animate-pulse w-40" />
        </div>
      </div>
        ...
        <div className="col-span-8 stamp-card p-0 overflow-hidden">
          ...
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="px-3 py-4 border-b border-warm-200/50">
              <div className="h-4 bg-cream-2 rounded-md animate-pulse w-1/2" />
            </div>
          ))}
        </div>
        <div className="col-span-4 space-y-4">
          <div className="stamp-card aspect-square bg-cream-2 animate-pulse" />
        </div>
      </div>
    </div>
  )
